...
Objeto_t bolita={0,0,6,2,{0x3c,0x7e, 0x7e, 0x7e, 0x3c},(240 -(2 * 5)) / 2,(320 -(2 * 8)) / 2};
...
void main(void) {
    ...
    display_drawCustomChar(0, 0, jugador1.forma, 0x07E0, 0x0000,jugador1.escala);
    display_drawCustomChar(0, 320 -(jugador2.escala * 8), jugador2.forma, 0x07E0, 0x0000,jugador2.escala);

    display_drawCustomChar(bolita.posicionx,bolita.posiciony,bolita.forma,0xFFFF, 0x0000,bolita.escala);
    dibujarMarcador(0,0);
    while (1) {
        ...
        if (!(movimiento_jugador1 || movimiento_jugador2)) {
            _delay((unsigned long)((65)*(32000000/4000.0)));
        ...
        display_drawCustomChar(bolita.posicionx,bolita.posiciony,bolita.forma,0x0000,0x0000,bolita.escala);
        if (bolita.posicionx >= (240 -(2 * 5))) {
            bolita.sentidox = 1;
        } else if (bolita.posicionx <= 10) {
            bolita.sentidox = 0;
        }

        if (bolita.posiciony >= ((320 -(2 * 8))-16)) {
            ...
            if ((bolita.posicionx >= jugador2.posicion)&&(bolita.posicionx <= (jugador2.posicion+((5 * 13) / 2)) + 30)) {
                ...
                puntaje1++;
                dibujarMarcador(puntaje1,puntaje2);
                bolita.posicionx=(240 -(2 * 5)) / 2;
                bolita.posiciony=(320 -(2 * 8)) / 2;
            }
        ...
        display_drawCustomChar(bolita.posicionx, bolita.posiciony, bolita.forma, 0x07E0, 0x0000,bolita.escala);
...
void moverJugador(Jugador_t *jugador) {
    uint8_t y = 0;
    if (jugador->id) {
        y = 320 -(jugador->escala * 8);
    }

    display_drawCustomChar(jugador->posicion, y, jugador->forma, 0x0000, 0x0000, jugador->escala);
    if (jugador->sentido) {
        jugador->posicion += jugador->velocidad;
    } else {
        jugador->posicion -= jugador->velocidad;
    }
    display_drawCustomChar(jugador->posicion, y, jugador->forma, 0x07E0, 0x0000, jugador->escala);
}
